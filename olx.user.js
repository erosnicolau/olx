...
(function() {
    ...
    customCSS += ".hiddenAd:not(:hover) {height: 25px !important; min-height: unset !important; overflow: hidden; opacity: 0.15; display: block;}"
    customCSS += ".hiddenAd:not(:hover) tr + tr {display: none}"
    ...
    customCSS += ".hiddenAd:not(:hover) .thumb {line-height: 0 !important; text-align: left; max-height: 25px !important}"
